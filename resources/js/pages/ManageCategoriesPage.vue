        ...
        <div class="mt-4 overflow-hidden rounded-2xl border border-zinc-200">
          ...
          <div v-if="isLoading" class="space-y-3 bg-white p-5">
            <div
              v-for="item in 4"
              :key="item"
              class="h-16 animate-pulse rounded-2xl bg-zinc-100"
            ></div>
          </div>
          ...
          <div v-else-if="categories.length" class="divide-y divide-zinc-200 bg-white">
            ...
            >
              ...
              <div class="col-span-12 md:col-span-4 text-sm text-zinc-500">
                {{ category.slug }}
              </div>
          ...
          >
            ...
            <p class="mt-2 text-sm text-zinc-500">
              İlk kategori eklendiğinde burada listelenecek.
            </p>
          </div>
        </div>
      </section>
